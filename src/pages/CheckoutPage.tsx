...
const CheckoutPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simulate connecting for video call for 15 seconds
    ...
    <Layout className="bg-gradient-to-b from-background via-accent/5 to-background">
      <div className="py-12 min-h-[80vh]">
                      ...
                      <div className="w-full md:w-1/2 space-y-6">
                        <div className="rounded-lg border bg-white/50 dark:bg-black/20 p-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-between text-sm">
                              <span className="text-muted-foreground">Find Yo Fee</span>
                              <span>₹13.00</span>
                            </div>
                            <Separator className="my-2" />
                            <div className="flex justify-between font-medium">
                              <span>Total</span>
                              <span className="text-lg">₹{selectedPackage.price + 13}</span>
                            </div>
                          </div>
                        </div>
        ...
        <Dialog open={isConnecting} onOpenChange={() => {}}>
          <DialogContent className="sm:max-w-md bg-gradient-to-br from-white/95 to-white/90 dark:from-black/95 dark:to-black/90 backdrop-blur-md border-0 shadow-2xl overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-pink-500/5 via-purple-500/5 to-indigo-500/5 animate-pulse"></div>
            <div className="relative flex flex-col items-center justify-center space-y-6 py-8">
              <div className="relative w-28 h-28">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-20 h-20">
                    {/* Outer gradient ring */}
                    <div className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 animate-gradient-rotate"></div>
                    <div className="absolute inset-0.5 rounded-full bg-white dark:bg-black"></div>
                    
                    {/* Inner gradient ring */}
                    <div className="absolute inset-2 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 animate-gradient-rotate-reverse"></div>
                    <div className="absolute inset-[9px] rounded-full bg-white dark:bg-black"></div>
                    
                    {/* Center dot */}
                    <div className="absolute inset-4 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 animate-pulse"></div>
                  </div>
                </div>
              </div>
              
              <div className="text-center space-y-3">
                <h3 className="text-2xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent animate-gradient">
                  Scheduling Your Video Call
                </h3>
                <p className="text-muted-foreground max-w-sm">
                  Please complete your payment on the next page to confirm your booking
                </p>
              </div>
              
              <div className="w-full max-w-xs">
                <div className="relative h-3 bg-muted/50 rounded-full overflow-hidden">
                  <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 animate-progress"></div>
              ...
              <div className="flex items-center space-x-2 text-sm">
                <div className="flex items-center space-x-2 px-4 py-2 rounded-full bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-indigo-500/10">
                  <ShieldCheck className="h-4 w-4 text-green-500" />
                  <span className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent font-medium">Secure Booking</span>
                </div>
              </div>
            </div>
          </DialogContent>
